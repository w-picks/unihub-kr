...
<div id="main_wrapper">
    <section id="main_vid">
        <article>
            <h2 class=""><span>R&D를 선도하는</span><br>
                국내대학의 해외 특허 활용,<br>
                UNIHUB가 함께합니다.</h2>
            <button class="uni_btn" onclick="contactUsMain()">UNIHUB 참여하기</button>
        </article>
    </section>
    <section id="business">
    ...
    <section id="partners">
        ...
        <button class="uni_btn color1 scroll-trans" onclick="contactUsMain()">참여하기</button>
        <article>
    </section>
...
echo latest('theme/review', 'broadcast', 3, 30);
?>
