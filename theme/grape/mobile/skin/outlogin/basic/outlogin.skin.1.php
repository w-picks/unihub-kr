...
<div class="ol">
  ...
  <a href="<?php echo G5_BBS_URL ?>/faq.php?la=kr" class="btn_s contact_us" style="padding-left: 10px;" onclick="contactUs()">문의하기</a>
...
<script>
  const contactUs = () => {
    ...
    // window.location.href='<?php echo G5_BBS_URL ?>/faq.php?la=kr'
